...
K1_FAST_CURVE="secp256k1"
SUPPORTED_CURVES="$DEFAULT_CURVE|$FAST_CURVE|$K1_FAST_CURVE"
...
#echo "generating digest: $digest cert: $cert key:$privk"
#echo "openssl req -new -key $privk -x509 -nodes -days 365 -out $cert -$digest -subj=/CN=$name"
#echo ""
